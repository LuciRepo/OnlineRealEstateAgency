...
<title>Editare detalii client</title>
</head>
<body>

<br><b>Edit client's details</b><br/><br/>
<form:form action="${pageContext.request.contextPath}/editClient.htm" commandName="clientForm" method="post">
