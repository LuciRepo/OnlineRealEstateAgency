...
<body>
<b>Edit Real Estate:</b><br><br>
<form:form action="${pageContext.request.contextPath}/editRealEstate.htm" commandName="realEstateForm" method="post">
...
<form:option value="0" itemValue="" itemLabel="Select the Client(if available)"/>
