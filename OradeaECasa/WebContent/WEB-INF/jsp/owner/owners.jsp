      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Owners Management</h6>
            <a class="collapse-item" href="addOwner.htm"><b>Add a new Owner</b> </a>
...
<br><b>Registered owners</b><br/><br>
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
<c:forEach items="${model.owners}" var="o">
<tr>
	<td><c:out value="${o.name}"/></td>
    <td><c:out value="${o.identificationCode}"/></td>
    <td><c:out value="${o.phoneNumber}"/><td>
    <td><c:out value="${o.email}"/><td>
    <td><a href="./detailsOwner/${o.id}">Details</a></td>
    <td><a href="./editOwner/${o.id}">Edit</a></td>
    <td><a href="./deleteOwner/${o.id}">Delete</a></td>
    </tr>
</c:forEach>
</table>
