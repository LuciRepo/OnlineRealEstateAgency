package ro.oradeaecasa.DBHelper;
...
public class DBHelper {
	public static Connection getConnection() {
        ...
        try {
        Class.forName("com.mysql.jdbc.Driver"); //rezolva problema de lazy loading
        } catch (Exception ex) {
        	ex.printStackTrace();
        }
        String connString = "jdbc:mysql://localhost:3306/oradeaecasa";
        try {
